...
6. **Соцсети** — Instagram, TikTok и Spotify в шапке/Hero уже реальные
   (`uteshov.tour` и профиль на Spotify). Ссылки на YouTube-канал и
   Telegram-канал пока не присланы — добавьте их в `.hero-socials` и
   footer, когда будут известны.
